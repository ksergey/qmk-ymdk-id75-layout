...
#define K_SPCSL LSFT_T(KC_SPACE)
#define K_ENTSR RSFT_T(KC_ENT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
   ...
   KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_INS,   KC_INS,   KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_UP,    KC_RSFT, \
   KC_LCTL,  KC_LGUI,  KC_LALT,  K_LOWER,  XXXXXXX,  K_SPCSL,  KC_DEL,   KC_BSPC,  XXXXXXX,  K_ENTSR,  K_RAISE,  XXXXXXX,  KC_LEFT,  KC_DOWN,  KC_RGHT  \
 ),
 ...
 [_RAISE] = LAYOUT_ortho_5x15( /* FUNCTION */
   ...
   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  RGB_M_P,  RGB_M_B,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, \
   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  RGB_M_X,  RGB_M_G,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  K_ACT1, \
