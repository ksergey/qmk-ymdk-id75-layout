...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
   ...
   KC_LCTL,  KC_LGUI,  KC_LALT,  MO(_FN),  KC_SPC,   KC_SPC,   KC_SPC,   KC_SPC,   MO(_FN),  KC_RALT,  KC_RGUI,  KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT  \
 ),
 ...
 [_FN] = LAYOUT_ortho_5x15( /* FUNCTION */
   ...
   RGB_MOD,  RGB_M_X,  RGB_M_G,  RGB_M_T,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  _ACT1_,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, \
